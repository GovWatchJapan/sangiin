...
export const PARTY: Record<string, { short: string; en: string; color: string }> = {
  ...
  "国民民主党・新緑風会":    { short: "国民",   en: "DPP",         color: "oklch(0.62 0.15 65)" },
  ...
  "社民":                    { short: "社民",   en: "SDP",         color: "oklch(0.58 0.15 15)" },
  "N党":                     { short: "N党",    en: "NHK Party",   color: "oklch(0.55 0.14 50)" },
  ...
  "みらい":                  { short: "みら",   en: "Mirai",       color: "oklch(0.55 0.14 200)" },
};
